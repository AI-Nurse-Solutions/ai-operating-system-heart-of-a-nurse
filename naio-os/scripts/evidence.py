...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check Phase 16 EDENA Evidence Trail readiness for a rendered NAIO profile bundle.")
    ...
    if args.json:
        ...
        print("\n=== NAIO OS — Phase 16 EDENA evidence trail check ===\n")
        print(json.dumps(report, indent=2))
