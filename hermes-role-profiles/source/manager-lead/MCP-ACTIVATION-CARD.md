...
- Profile: `manager-lead` version `1.0.0`
- Mapped product and lane: `LEAD — Nurse Leader & Manager` / `lead`
- Mapping classification: `direct_role_conditional`
- Mapping eligibility condition: Only when the user is actually operating as a nurse leader or manager; selection does not establish authority.
