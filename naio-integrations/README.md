...
conditions — and a consequential recommendation (Yellow and above, in
Recommend mode) that arrives as a naked verdict is refused at the
gateway with `EDENA-JUDGMENT-VISIBILITY`. Each result carries the
