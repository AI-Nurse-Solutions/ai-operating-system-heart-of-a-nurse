...
class NurseLeaderCompleteEditionTests(unittest.TestCase):
    ...
    def test_public_lane_copy_classifies_lead_as_self_install_build_kit(self):
        ...
        self.assertIn("Lanes 01, 02, 03, and 06 are reproducible self-install Hermes build kits", readme)
        ...
        self.assertIn("Lanes 01, 02, 03, and 06 are governed self-install Hermes build kits", current_surfaces["repository README"])
