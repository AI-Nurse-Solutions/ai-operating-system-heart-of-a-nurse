...
def check_launch(profile: Path) -> dict:
    ...
    if runtime.get("version") != "2.0.0-phase11":
        failures.append(f"runtime version is not 2.0.0-phase11: {runtime.get('version')}")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check Phase 11 Public Launch Pack readiness for a rendered NAIO profile bundle.")
    ...
    if args.json:
        ...
        print("\n=== NAIO OS — Phase 11 public launch check ===\n")
        print(json.dumps(result, indent=2))
