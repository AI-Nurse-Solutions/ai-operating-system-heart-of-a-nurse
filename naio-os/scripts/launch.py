...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check Phase 14 Public Launch Pack readiness for a rendered NAIO profile bundle.")
    ...
    if args.json:
        ...
        print("\n=== NAIO OS — Phase 14 public launch check ===\n")
        print(json.dumps(result, indent=2))
