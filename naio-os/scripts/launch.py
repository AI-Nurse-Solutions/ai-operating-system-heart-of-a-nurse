...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check Phase 15 Public Launch Pack readiness for a rendered NAIO profile bundle.")
    ...
    if args.json:
        ...
        print("\n=== NAIO OS — Phase 15 public launch check ===\n")
        print(json.dumps(result, indent=2))
