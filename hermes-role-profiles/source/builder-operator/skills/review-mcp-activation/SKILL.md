...
description: Perform read-only preflight for the builder-operator profile or one MCP candidate and produce the exact required card without installing, authenticating, connecting, or enabling anything.
version: 1.0.0
metadata:
  author: NAIO
  category: governance
