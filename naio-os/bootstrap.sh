#!/usr/bin/env bash
# =============================================================================
# NAIO OS — bootstrap.sh (Phase 11 signed cohort-mode installer)
# =============================================================================
...
headers = {'User-Agent': 'naio-os-bootstrap/2.0.0-phase11', 'Cache-Control': 'no-cache'}
