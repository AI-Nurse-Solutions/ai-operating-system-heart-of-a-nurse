...
BUILD_KIT_DOWNLOADS = {
    "nurse-educator": {
        ...
        "bytes": 6823419,
        "sha256": "fe9f96b4b908602cdae1e35f1643225d70b6f5068049cba1b707f2b8e66104dd",
        "member_count": 121,
        "verifier_sha256": "c79581cde1a4ede0c49bd2bc806d6ec74150859d34700a9fad19fc57873f7ae3",
        "source_zip_sha256_before_derivative": "8b7e8290382f7df5830554ad740a8fd280c3d2be5e8948d1a539afe074416cb9",
        "source_zip_bytes_before_derivative": 6820134,
        "target": {
            "home": "My TEACH Command Studio",
            "lane": "nurse_educator_instructional_designer",
            "namespace": "neid_teach.*",
            "product": "TEACH — Nurse Educator & Instructional Designer Mission Control",
            "product_id": "nurse-educator-instructional-designer-mission-control",
            "readiness": "not_operational_build_required",
            "route": "/nurse-educators-designers/dashboard",
            "version": "2.0.0",
        },
        "counts": {
            "acceptance_ledger_explicit_target_test_rows": 264,
            "agents": 10,
            "canonical_compatibility_checks": 169,
            "canonical_foundation_checks": 33,
            ...
            "templates": 24,
            "total_required_execution_records": 433,
...
def validate_build_kit_zip(role: dict, config: dict) -> dict:
    ...
    with zipfile.ZipFile(path) as archive:
        ...
        if defaults.get("workflows") != "Preview Only" or defaults.get("memory") != "session_only":
