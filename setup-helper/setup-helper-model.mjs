...
export function safeTaskForLane(lane) {
  const tasks = {
    ...
    staff_nurse: 'No-PHI task: Help me prepare for the Staff Nurse and Quality Contributor SHIFT Complete Edition without opening or requiring a package file and without installing anything. Ask me to choose Direct-Care Staff Nurse; Unit Champion, Preceptor, or Shared-Governance Member; Chartered Staff-Nurse QI Project Lead; or Hybrid / Multiple-Employer, and name my active task-level hat and Personal / none or employer context. Confirm whether my SOUL files and Hermes setup are complete. Then create a one-page no-PHI readiness checklist and one synthetic first-win personal-practice, learning, communication, career, capacity, or quality-preparation outline using only public or non-sensitive preferences I provide. Do not use patient, event, coworker, institutional, peer-review, quality, risk, employment, or restricted records. Do not install, save, connect, share, send, report, release, activate, automate, change care, change policy, or launch QI. State that downloading, selecting, opening, and unzipping do not install anything. At the later post-setup stage, I must provide the complete one-file SHIFT program, complete its read-only preflight, review the exact SHIFT Complete Edition Activation Card, and explicitly approve that exact card before any installation change. After approval Hermes creates, repairs, or binds the Staff Nurse foundation first, adds the inactive SHIFT overlay second, runs 176 embedded release checks, preserves compatible work, and keeps all twenty optional SHIFT SuperPowers, connectors, shared access, new memory categories, external actions, release, cron, and background automation off. State that role selection verifies no licensure, employment, competence, assignment, delegation, supervision, quality appointment, sponsor authority, institutional access, or data permission; and private-workspace approval does not authorize institutional quality work.',
