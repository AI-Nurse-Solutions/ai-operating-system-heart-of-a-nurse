...
- Profile: `clinician-resident` version `1.0.0`
- Mapped product and lane: `ROUNDS — Medical Resident` / `rounds`
- Mapping classification: `direct_fit`
- Mapping eligibility condition: Medical Resident ROUNDS context only; selection does not verify training status, supervision, competence, or authority.
