...
- Post-Setup Role Packs: `/post-setup/` — six English-language downloads for Student Nurse, Staff Nurse, Nurse Leader and Manager, Nurse Educator, Nurse-Connected Ally, and the USA-only Nurse Practitioner Complete Edition. Each is used only after SOUL files and Hermes setup, and downloading does not install anything. Lanes 01, 02, 04, and 05 are review-first overlays. Lane 03 is the Nurse Leader Complete AI OS with LEAD SuperPowers: read-only preflight, exact combined activation card, foundation-first installation, sixteen inactive optional powers, 113 release checks, safe checkpoints, and separate organizational-deployment authorization. Lane 06 uses the equivalent governed Complete Edition pattern with 145 embedded acceptance tests.
