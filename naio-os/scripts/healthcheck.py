...
passes. Checks the Phase 15 bundle is internally consistent.
"""
...
def main():
    parser = argparse.ArgumentParser(description="NAIO OS Phase 15 healthcheck")
...
def print_summary():
    ...
    if FAIL > 0:
        ...
        print("\n✅ HEALTHCHECK PASSED — bundle is internally consistent (Phase 15 target-only apply + activation + launch + cohort + evidence + contribution + pilot + readiness scope).")
