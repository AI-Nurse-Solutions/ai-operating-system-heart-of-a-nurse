# The improvement loop — monthly, 30 minutes

*The eighth verb. Run this once a month (put it in the calendar now). The loop reviews four things — workflows, prompts, knowledge, and the rules themselves — and installs lessons as changes, not reminders.*

---

**Prompt to paste, once a month:**

Run the improvement loop. Work through the four asset classes, one finding each:

1. **Workflows.** Read the ledger since the last loop. Where did I edit or reject your output most? Which workflow's "work-as-done" differs from its written steps? Propose ONE concrete change to ONE workflow file (or its header).

2. **Prompts & instructions.** Which recurring instruction did I have to repeat or correct this month? Propose the sentence that should be added to (or removed from) CHARTER.md, a workflow, or these prompt files so I never have to say it again.
