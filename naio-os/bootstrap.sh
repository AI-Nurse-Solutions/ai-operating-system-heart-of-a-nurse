#!/usr/bin/env bash
# =============================================================================
# NAIO OS — bootstrap.sh (Phase 16 signed cohort-mode installer)
# =============================================================================
...
headers = {'User-Agent': 'naio-os-bootstrap/2.0.0-phase16', 'Cache-Control': 'no-cache'}
