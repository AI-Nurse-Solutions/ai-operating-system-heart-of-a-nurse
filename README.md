...
- STEWARD Governance Preview: `/hospital-clinic-administrators/` — a public, non-executable governance specification for future hospital and clinic administrative AI. It keeps one proposed `hospital_clinic_administration` lane with explicit enterprise, hospital, clinic, service-line, project, dual-hat, and unknown-authority context variants. It includes no installer, agents, production connectors, original installer-facing payload, or operational-data authorization. The installable Complete AI OS claim is paused until a Florence-X/EDENA adapter proves pre-model data controls, authenticated authority, segregation of duties, typed permissions, privacy-safe aggregation, lifecycle controls, and an evidence-bearing runtime release ledger.
