...
- Post-Setup Role Packs: `/post-setup/` — six English-language downloads for Nursing Student and Nursing Assistant, Staff Nurse and Quality Contributor, Nurse Leader and Manager, Nurse Educator and Instructional Designer, Nurse-Connected Ally, and the USA-only Nurse Practitioner. Each is used only after SOUL files and Hermes setup, and downloading does not install anything. Lane 05 is the remaining review-first overlay. Lane 01 is the Nursing Student and Nursing Assistant FUTURE Complete Edition with 136 embedded release checks. Lane 02 is the Staff Nurse and Quality Contributor SHIFT Complete Edition with four authority adapters, 20 inactive optional SuperPowers, and 176 embedded release checks. Lane 03 is the Nurse Leader LEAD Complete Edition with 113 checks. Lane 04 is the Nurse Educator and Instructional Designer TEACH Complete Edition with three authority adapters, 20 inactive optional SuperPowers, and 169 embedded release checks. Lane 06 is the USA-only NP Complete Edition with 145 checks. Every Complete Edition uses read-only preflight, exact activation-card approval, foundation-first installation, safe checkpoints, preserved compatible work, and separate institutional-deployment authorization.
...
- Latest Architecture Report: `/architecture-report.html` with stable PDF/Markdown downloads under `assets/nurse-ai-os-architecture-report.*` and date-stamped 2026-07-13 archive copies — documents the signed Governed Harness, `active_shadow` posture, six English role lanes, architecture gaps, non-claims, and governed roadmap; it does not authorize canary enforcement, PHI, or clinical deployment.
