...
def main() -> int:
    ap = argparse.ArgumentParser(description="Check Phase 17 Cohort / Instructor Mode readiness for a rendered NAIO profile bundle.")
    ...
    if args.json:
        ...
        print("\n=== NAIO OS — Phase 17 cohort readiness check ===\n")
        print(json.dumps(report, indent=2))
