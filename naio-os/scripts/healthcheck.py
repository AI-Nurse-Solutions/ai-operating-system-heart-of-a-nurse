...
passes. Checks the Phase 14 bundle is internally consistent.
"""
...
def main():
    parser = argparse.ArgumentParser(description="NAIO OS Phase 14 healthcheck")
...
def print_summary():
    ...
    if FAIL > 0:
        ...
        print("\n✅ HEALTHCHECK PASSED — bundle is internally consistent (Phase 14 target-only apply + activation + launch + cohort + evidence + contribution + pilot scope).")
