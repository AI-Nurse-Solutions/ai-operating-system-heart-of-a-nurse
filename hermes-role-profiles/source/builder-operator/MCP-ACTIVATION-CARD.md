...
- Profile: `builder-operator` version `1.0.0`
...
- Mapping eligibility condition: Healthcare research or innovation solution-preparation context only; not a generic software-builder or code-shipping role and not an exact DISCOVER lane identity.
