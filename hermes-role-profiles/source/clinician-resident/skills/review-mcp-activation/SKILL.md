...
description: Perform read-only preflight for the clinician-resident profile or one MCP candidate and produce the exact required card without installing, authenticating, connecting, or enabling anything.
version: 1.0.0
metadata:
  author: NAIO
  category: governance
