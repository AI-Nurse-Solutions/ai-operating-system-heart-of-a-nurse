...
- Post-Setup Role Packs: `/post-setup/` — six English-language downloads for Nursing Student and Nursing Assistant, Staff Nurse, Nurse Leader and Manager, Nurse Educator, Nurse-Connected Ally, and the USA-only Nurse Practitioner. Each is used only after SOUL files and Hermes setup, and downloading does not install anything. Lanes 02, 04, and 05 are review-first overlays. Lane 01 is the Nursing Student and Nursing Assistant Complete AI OS with FUTURE SuperPowers: three protected pathways, read-only preflight, exact combined activation card, foundation-first installation, eighteen inactive optional powers, 136 embedded release checks, safe checkpoints, and separate school/employer/organizational-deployment authorization. Lanes 03 and 06 use the equivalent governed Complete Edition pattern with 113 and 145 embedded checks respectively.
