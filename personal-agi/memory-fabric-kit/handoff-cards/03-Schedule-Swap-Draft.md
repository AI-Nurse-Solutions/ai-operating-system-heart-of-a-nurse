...
| **Stop conditions** | Universal list, plus: if your stated reason for the swap includes anything patient- or unit-sensitive, it drafts the request *without* the reason and tells you it did so. |
...
| **Revoke** | Delete this card from your vault; tell your AI the card is revoked. |
