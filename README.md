...
- Local HTML Life Dashboard fallback — single-file browser dashboard for nurses who cannot use Notion; save it locally and bookmark it under Dashboards after setup
...
- Step 12 — Nurse AI Side-Gig Starter Kit: added `/side-gig-starter-kit/`, a dedicated downloadable ZIP, and starter-kit source folder as the first doorway into NIN/NAIO for nurse entrepreneurs validating one safe no-PHI side project before cohorts or advanced builder pathways.
