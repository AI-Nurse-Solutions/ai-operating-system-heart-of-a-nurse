...
- Profile: `clinician-np` version `1.0.0`
- Mapped product and lane: `WINGS — Nurse Practitioner` / `wings`
- Mapping classification: `direct_country_restricted`
- Mapping eligibility condition: United States NP context only; selection does not verify licensure, certification, privileges, or authority.
