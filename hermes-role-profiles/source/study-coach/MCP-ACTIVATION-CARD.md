...
- Profile: `study-coach` version `1.0.0`
- Mapped product and lane: `FUTURE — Nursing Student & Nursing Assistant` / `future`
- Mapping classification: `direct_pathway_only`
- Mapping eligibility condition: Nursing Student pathway only; not automatically Nursing Assistant or Bridge.
