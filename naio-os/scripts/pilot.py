...
def check_profile(profile: Path) -> dict:
    ...
    required=[
        'Phase 16 Institutional Pilot Pack','Pilot Charter','Stakeholder Brief','Risk Register','No-PHI Pilot Boundary',
...
def main():
    ap=argparse.ArgumentParser(description='Check Phase 16 Institutional Pilot Pack readiness for a rendered NAIO profile bundle.')
    ...
    if args.json: print(json.dumps(report, indent=2))
        ...
        print('\n=== NAIO OS — Phase 16 institutional pilot check ===\n'); print(json.dumps(report, indent=2))
