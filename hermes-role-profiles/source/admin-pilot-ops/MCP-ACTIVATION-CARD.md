...
- Profile: `admin-pilot-ops` version `1.0.0`
- Mapped product and lane: `STEWARD — Hospital & Clinic Administrator` / `steward`
- Mapping classification: `conditional_candidate`
- Mapping eligibility condition: Hospital or clinic administration context only; not generic administration and not an automatic identity match.
