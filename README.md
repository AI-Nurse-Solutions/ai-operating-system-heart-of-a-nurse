...
- Post-Setup Role Packs: `/post-setup/` — six English-language downloads for Nursing Student and Nursing Assistant, Staff Nurse and Quality Contributor, Nurse Leader and Manager, Nurse Educator and Instructional Designer, Nurse-Connected Ally, and the USA-only Nurse Practitioner. Each is used only after SOUL files and Hermes setup, and downloading does not install anything. Lanes 01, 02, 03, and 04 are governed self-install Hermes build kits: FUTURE declares 136 canonical compatibility checks and 349 required execution records, SHIFT declares 176 canonical checks, LEAD declares 113 canonical checks initially `Not Run`, and TEACH declares 169 canonical checks and 433 required execution records. Optional powers remain inactive and suggested agents remain disabled. Hermes verifies the complete ZIP, performs read-only environment preflight, and presents one exact Implementation Activation Card before any local mutation. Lane 06 remains the WINGS Complete Edition with its exact combined activation-card gate. Lane 05 remains a review-first overlay. No lane becomes operational or institutionally authorized by publication, download, opening, or unzipping.
