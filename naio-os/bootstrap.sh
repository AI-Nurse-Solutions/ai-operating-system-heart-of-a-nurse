#!/usr/bin/env bash
# =============================================================================
# NAIO OS — bootstrap.sh (Phase 14 signed cohort-mode installer)
# =============================================================================
...
headers = {'User-Agent': 'naio-os-bootstrap/2.0.0-phase14', 'Cache-Control': 'no-cache'}
