...
- Post-Setup Role Packs: `/post-setup/` — six English-language downloads for Student Nurse, Staff Nurse, Nurse Leader and Manager, Nurse Educator, Nurse-Connected Ally, and the USA-only Nurse Practitioner Complete Edition. Each is used only after SOUL files and Hermes setup, and downloading does not install anything. Lanes 01–05 are review-first overlays; lane 06 uses a read-only preflight, combined activation card, foundation-first phased installation, 145 embedded acceptance tests, safe checkpoints, and inactive-by-default NP Wings.
