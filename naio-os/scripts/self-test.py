...
def verify_target(target: Path) -> None:
    ...
    check("runtime version phase5", runtime.get("version") == "2.0.0-phase5")
...
def main() -> int:
    ...
    if FAIL:
        ...
        print("\n✅ SELF-TEST PASSED — bundle behavior is consistent with Phase 5 safety contract.")
